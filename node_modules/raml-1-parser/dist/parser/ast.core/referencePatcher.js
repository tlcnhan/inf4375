...
var ReferencePatcher = (function () {
    ...
    ReferencePatcher.prototype.patchType = function (node, rootNode, resolver, units) {
        ...
        if (!isExternal) {
            ...
            var this_1 = this;
            var llNode, localUnit, localPath, value, gotExpression, transformer, stringToPatch, escapeData, additionalUnits, actualNode, actualValue, appendedAdditional, appendedAttrUnit, parsedExpression, expressionPatchFailed, expr, gotPatch, patched, llTypeNode, def, newNode, appended;
            for (var _c = 0, typeAttributes_1 = typeAttributes; _c < typeAttributes_1.length; _c++) {
                var typeAttr = typeAttributes_1[_c];
                var state_1 = _loop_1();
