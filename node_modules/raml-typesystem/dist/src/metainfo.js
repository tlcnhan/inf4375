...
var ImportedByChain = (function (_super) {
    __extends(ImportedByChain, _super);
    function ImportedByChain(_typeName) {
        _super.call(this, "importedByChain", _typeName, true);
        ...
        if (typeof this.value() === 'object') {
            ...
            if (v) {
                Object.keys(v).forEach(function (x) {
                    var exampleObj = v[x];
                    if (exampleObj) {
                        var hasVal_1 = exampleObj.hasOwnProperty('value');
                        if (typeof exampleObj == "object" && hasVal_1) {
